...
- [ ]  Have I made a conscious choice between using HEX codes, RGB values, or HSB/HSL section methods? Have I leveraged the power of HSB to create a full color scheme?
...
- [ ]  Are there smart defaults that look nice when no user-generated content has been added?
...
- [ ]  Are my icons decorative or interactive and have I made that extremely clear with the designs?
...
- [ ]  Have I considered how the product’s marketing site or branding should or will impact the interface?
...
- [ ]  If my project is an application, have I used a mobile-first approach to create simplicity up front?
